    ...
    <div class="card-body p-0">
        <div class="d-flex align-items-center justify-content-between card-spacer flex-grow-1">
            <div class="d-flex flex-column text-left">
                <span class="text-dark-75 font-weight-bolder font-size-h3">$0.00</span>
                <span class="text-muted font-weight-bold mt-2">TOTAL EARNED</span>
            </div>
        ...
        <div class="row d-flex align-items-center justify-content-between card-spacer">
            <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                <div class="d-flex flex-column text-left">
                    ...
                    <span class="text-muted font-weight-bold mt-2">CLAIM</span>
                </div>
            </div>
            <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                <div class="d-flex flex-column text-left">
                    <span class="text-dark-75 font-weight-bolder font-size-h3">$0.00</span>
                    <span class="text-muted font-weight-bold mt-2">UNCLAIMED</span>
                </div>
                <span class="btn btn-success btn-xs v-chip v-chip--label theme--dark v-size--x-small" id="show-btn" @click="showModal">
                    Cash Out
                </span>
    ...
    methods: {
        async showModal() {
            const ok = await this.$refs.confirmDialogue.show({
                title: 'Cash Out',
                message: 'Your unclaimed rewards will be reset to $0.00 after you click Request Cash Out button. Cash out request will be processed not more than 7 days. You won\'t receive full cash out rewards bacause PayPal will take some for processing fees.',
                okButton: 'Cast Out',
            })

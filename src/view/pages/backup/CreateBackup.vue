    ...
    <v-app>
      <div class="innerlayout_wrapper">
        <v-container fluid>
          ...
          <v-subheader class="createbackup_subtitle"
            ><strong>Store in {{ store }}</strong></v-subheader
          >
          ...
          <v-radio-group v-model="backup_plan">
            ...
            <v-radio
              value="wordpress"
              label="Toggle this custom radioBoth (Recommended for WordPress)"
            ></v-radio>
            <v-radio value="webapp" label="Web Application"></v-radio>
            <v-radio value="database" label="Database"></v-radio>
          </v-radio-group>
          ...
          <v-select :items="databases" label="Database" outlined></v-select>
          ...
          <v-subheader class="createbackup_subtitle"
            ><strong>Backup Every</strong></v-subheader
          >
          <v-slider
            v-model="slider1"
            thumb-label="always"
          ...
          >
          <v-dialog v-model="agreeDialog" persistent max-width="290">
            <v-card>
          ...
          >
            ...
            <v-time-picker v-if="timer_dialog" v-model="time" full-width>
              <v-spacer></v-spacer>
              <v-btn text color="primary" @click="timer_dialog = false">
                Cancel
              </v-btn>
          ...
          <v-subheader class="createbackup_subtitle"
            ><strong>Backup File Retention</strong></v-subheader
          >
          <v-slider
            v-model="slider2"
          ...
          <v-subheader class="createbackup_subtitle"
            ><strong
              >Send notification to Email, Slack and/or Telegram when</strong
            ></v-subheader
          >
          <v-checkbox
            v-model="failed"
          ...
          <br />
          <br />
          <v-btn block color="success">Create</v-btn>
        </v-container>
      </div>
    </v-app>
  </div>

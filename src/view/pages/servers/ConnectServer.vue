                    ...
                    <div class="col-sm-12 col-md-7 col-lg-8 col-xs-12">
                      ...
                      <div class="content">
                        <ol v-if="provision_type == 'ipaddress'">
                          <li>
                            You need to have a cloud Virtual Private Server
                            (VPS) hosting first to use RunCloud.
                          </li>
                          <li>
                          ...
                          <li>
                            ...
                            <strong
                              >fresh Ubuntu server (18.04/20.04 LTS
                              64bit)</strong
                            >.
                          </li>
                          <li>
                          ...
                          <li>
                            Please enable inbound traffic for 80/tcp, 443/tcp
                            and 34210/tcp if you are using external firewall.
                            Read
                            <a
                              href=""
                              target="_blank"
                        ...
                        <ol v-if="provision_type == 'build'">
                          ...
                          <li>
                            ...
                            <a
                              ...
                              >here</a
                            >
                            on how to generate and add your VPS provider API
                            key.
                          </li>
                          <li>
                            Choose your desired instance setup and we will
                            deploy it for you
                          </li>
                        </ol>
                      </div>
                        ...
                        <div class="d-flex">
                          ...
                          <div class="d-inline-block">
                            ...
                            <p style="margin-top: 8px">
                              Native Nginx, Nginx-Apache2 Hybrid, and custom
                              Nginx web app stack.
                            </p>
                            <!---->
                          </div>
                ...
                <form action="" method="POST" role="form">
                  ...
                  <div class="form-group">
                    ...
                    <p class="form-input-description">
                      You can create API Key for Amazon Web Service by using
                      this URL:

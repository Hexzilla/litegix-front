  ...
  <div class="card card-custom">
    ...
    <div class="card-header py-3">
      <div class="card-title align-items-start flex-column">
        <h1 class="font-weight-bolder text-dark mt-5">
          Newsletter
        </h1>
      ...
      <div class="card-body">
        <div class="row border-bottom">
          <div class="col-lg-6 col-xl-9 ">
            <h4 class="font-weight-bold mb-6">
              <i class="v-icon notranslate v-alert__icon mdi mdi-check-circle theme--dark --v-secondary-lighten5"></i>
              Newsletter Subscription</h4>
          </div>
          <div class="col-lg-6 col-xl-3 v-card__actions">
            <a href="#" class="btn btn-danger btn-sm la-pull-right">
              <span class="font-weight-bold mb-6">
        ...
        <div class="row mt-12">
          <div class="col-lg-9 col-xl-6">
            <h5 class="font-weight-bold mb-6">Newsletter Subscription</h5>
          </div>
        </div>
        <div class="mb-6">
          <!--begin::Content-->
          <div class="d-flex align-items-center flex-grow-1">
            <!--begin::Checkbox-->
            <label
              class="checkbox checkbox-lg checkbox-lg checkbox-single flex-shrink-0 mr-4 v-treeview"
            >
            ...
            >
              <div class="d-flex flex-column align-items-cente py-2">
                <div class="text-dark-75 font-weight-bold text-hover-primary font-size-lg mb-1">
                  Updates and Announcements
                </div>
                <span class="text-muted font-weight-bold">
                  Stay up to date with the latest announcements and promotions from RunCloud
                </span>
              </div>
            </label>
            <!--end::Section-->
            ...
            >
              <div class="d-flex flex-column align-items-cente py-2">
                <div
                  ...
                  >Blog</div>
                <span class="text-muted font-weight-bold">
                  Whenever a blog post is published, you will be the first to know!
                </span>
              </div>
            </label>
            <!--end::Section-->
    ...
    <div class="card-body">
      <v-card-title>
        ...
        <v-text-field
          ...
          class="mr-2"
        ></v-text-field>
        <router-link to="/settings/notification/add" v-slot="{ href, navigate }">
      ...
      <div>
        <span class="text--lighten-1 font-size-sm mt-8">
            Here you can add notifications to notify you on certain events. You can add <b>Slack, Telegram and Email </b>for the notification channel. You then can hook the registered notifications to your <b> Servers, Atomic Deployment </b> and <b> Payment History (soon)</b>.
          </span>
      </div>
      <v-data-table
        :headers="headers"
